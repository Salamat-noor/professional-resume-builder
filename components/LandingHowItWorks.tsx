    ...
    <section className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center max-w-xl mx-auto mb-16">
          <p className="text-xs font-semibold text-indigo-600 uppercase tracking-widest mb-3">Simple Process</p>
          <h2 className="text-4xl font-bold text-gray-900 mb-4">From blank page to job offer</h2>
          <p className="text-lg text-gray-600">Create a professional resume in under 15 minutes. No design skills required.</p>
        </div>
        ...
        <div className="mt-16 bg-gradient-to-r from-indigo-50 to-blue-50 rounded-3xl p-10 flex items-center gap-10">
          <div className="flex-1">
            <h3 className="text-2xl font-bold text-gray-900 mb-2">See it in action</h3>
            <p className="text-gray-600 mb-5">Watch how our AI transforms a basic resume into a job-winning document in real time.</p>
            <button className="flex items-center gap-3 bg-indigo-600 text-white px-6 py-3 rounded-xl font-medium hover:bg-indigo-700 transition-colors cursor-pointer whitespace-nowrap">
              <div className="w-5 h-5 flex items-center justify-center"><i className="ri-play-circle-line text-lg"></i></div>
              Watch Demo (2 min)
            </button>
          </div>
          <div className="w-80 h-48 rounded-2xl overflow-hidden shadow-xl bg-gray-200 relative">
            ...
            <div className="absolute inset-0 flex items-center justify-center bg-indigo-900/30">
              <div className="w-14 h-14 flex items-center justify-center bg-white/90 rounded-full shadow-lg cursor-pointer hover:scale-110 transition-transform"><i className="ri-play-fill text-2xl text-indigo-600 ml-1"></i></div>
            </div>
          </div>
        </div>
      </div>
