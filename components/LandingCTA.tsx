  ...
  return (
    <section className="py-24 bg-gradient-to-br from-primary via-primary to-blue-700 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
        ...
        <p className="text-xl text-primary-foreground/80 mb-10 max-w-xl mx-auto">Start building for free. No credit card, no limits on what you can create. Your next career move starts here.</p>
        <div className="flex items-center justify-center gap-4">
          <Link href="/auth" className="bg-white text-primary font-bold px-8 py-4 rounded-xl hover:bg-primary-50 transition-colors shadow-xl whitespace-nowrap cursor-pointer text-lg">Start Building Free</Link>
        ...
        <div className="flex items-center justify-center gap-8 mt-10">
          {['No credit card required','14-day money-back guarantee','Cancel anytime'].map(t => (
            <div key={t} className="flex items-center gap-2 text-primary-foreground/60 text-sm">
