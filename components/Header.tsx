  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-background/95 backdrop-blur border-b border-border">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        <Link
          href="/"
          className="font-['Pacifico'] text-2xl text-primary whitespace-nowrap"
        >
          ClarityCV
        </Link>
        ...
        <div className="hidden md:flex items-center gap-3">
          {loading ? (
            ...
            <>
              <Link
                href="/auth"
                className="text-sm text-muted-foreground hover:text-primary px-4 py-2 whitespace-nowrap cursor-pointer"
              >
                Sign In
              </Link>
              <Link
      ...
      {mobileOpen && (
        <div className="md:hidden bg-background border-t border-border px-6 py-4 flex flex-col gap-3">
          ...
          {loading ? null : user ? (
            ...
            <Link
              href="/onboarding"
              className="text-sm bg-primary text-primary-foreground px-4 py-2 rounded-xl text-center cursor-pointer"
            >
              Get Started Free
            </Link>
          )}
